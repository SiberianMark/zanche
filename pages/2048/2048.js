...
var config = {
    ...
    onLoad: function() {
        ...
        //计算当前豪车
        this.culCurCar(this.data.grids);
    ...
    culCurCar(grids){
      //计算当前豪车
      let maxValue = 2;
      grids.forEach(function (row, rIndex) {
        row.forEach(function (col, cIndex) {
          if (col && col.value && col.value > maxValue) {
            maxValue = col.value;
          }
        });
      });
      this.setData({
        curCar: pageData[maxValue]
      });
    }
};
